                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            @if($item->event_photo != null)
                                <img src="{{ asset('storage/app/public/Resources/Event/Photos/' . $item->event_photo) }}" alt="{{ $item->event_name }} Photo" style="max-width: 120px; height: 80px;">
                            @else
                                <img src="{{ asset('storage/app/public/Resources/Event/Photos/event.jpg') }}" alt="{{ $item->event_name }} Photo" style="max-width: 120px; height: 80px;">
                            @endif
                        </td>                        
