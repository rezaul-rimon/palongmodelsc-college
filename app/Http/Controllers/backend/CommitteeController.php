        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                if ($request->hasFile('committeePhoto')) {
                    ...
                    $photo->move(public_path('Resources/Committee/Photos'), $filename);
    
                    // Delete the old file if it exists
                    if ($committee->committee_photo) {
                        $oldPhotoPath = public_path('Resources/Committee/Photos/' . $committee->committee_photo);
    ...
    public function delete_committee($id){
        try {
            ...
            if ($committeePhoto) {
                ...
                $photo_path = public_path('Resources/Committee/Photos') . '/' . $committeePhoto;
