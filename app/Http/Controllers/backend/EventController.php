    ...
    public function update_event(Request $request, $id) {
        ...
        if ($validator->fails()) {
            ...
            if ($request->hasFile('eventPhoto')) {
                ...
                $photo->move(public_path('Resources/Event/Photos'), $filename);
        
                if ($event->event_photo) {
                    $oldPhotoPath = public_path('Resources/Event/Photos/' . $event->event_photo);
    ...
    public function delete_event($id) {
        try {
            ...
            if ($eventPhoto) {
                ...
                $photo_path = public_path('Resources/Event/Photos') . '/' . $eventPhoto;
