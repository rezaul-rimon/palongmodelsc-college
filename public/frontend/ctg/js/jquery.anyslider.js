...
if(options.showBullets&&orgNumSlides>1){var i,active,out='<div class="as-nav"></div>',nav=$(out);for(i=1;i<=orgNumSlides;i++){active='';if(i===current){active=' class="as-active"';}
...
if(startTime!==0&&currentTime-startTime<1000&&currentDistance>10){e.preventDefault();if(currentX<startX){next();}else if(currentX>startX){prev();}
...
return{currentSlide:currentSlide,goTo:goTo,next:next,pause:pause,play:play,prev:prev};});$.fn.anyslider=function(options){return this.each(function(){var slider=$(this),anyslider;if(slider.data('anyslider')){return slider.data('anyslider');}
